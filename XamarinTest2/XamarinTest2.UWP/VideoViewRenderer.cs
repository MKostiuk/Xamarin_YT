...
{
    class VideoViewRenderer : ViewRenderer<VideoView, MediaElement>
    {
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == VideoView.VideoProperty.PropertyName)
            {
                SetSource();
            }
            else if (e.PropertyName == VideoView.AutoPlayProperty.PropertyName)
            {
                SetAutoplay();
            }
        }
